...
<div id="content">
    ...
    <div class="serch">
        <input  id="findtime" type="text" name="" class="text"placeholder="按时间查找"/>
        ...
        <button  class="submit" id="testBtn" onclick=" exportXls()">导出</button>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="workdate" type="date" name="workdate"  disabled="disabled"/>
                                    <p class="help-block"></p>
                                </div>
                            </div>
                            <div class="control-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="addLog()">提交</button>
